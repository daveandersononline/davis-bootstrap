...
(() => BbPromise.resolve().then(() => {
  ...
  const davis = new Davis({
    ...
    logLevel: 'info',
    userPlugins: ['./plugins/example', './plugins/siri', './plugins/kidsfighting', './plugins/smartscapeservices', './plugins/charlie', './plugins/googleanalytics', './plugins/deploydynatrace'], // uncomment this line to load the davisWeather plugin
  });
