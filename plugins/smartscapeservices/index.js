  ...
  constructor(davis, options) {
    ...
    this.intents = {
      ...
      smartscapeservices: {
        ...
        phrases: [
          'Can I please see the smartscape view?',
        ],
    ...
    this.hooks = {
      'smartscapeservices:gatherData': (exchange, context) => null,
      'smartscapeservices:respond': (exchange, context) => {
        ...
        var linkUrl = "https://jnc47888.live.dynatrace.com/#smartscape";
...
module.exports = Smartscapeservices;
