  ...
  constructor(davis, options) {
    ...
    this.hooks = {
      ...
      'firsttime:respond': (exchange, context) => {
        const resp = 'Yes I guess it was ok. I know you probably think it is amazing, but i am a more intelligent being, and honestly I would prefer to self heal these applications myself if you we would only let me. Oh by the way its pronounced data. Not dahdah.';
